...
public class PipelineConfigTests
{
    ...
    // {
    //     // Arrange
    //     var pipeline1 = new PipelineSpec
    //     {
    //         Name = "Pipeline1",
    //         SourceProvider = new PluginSpec { Type = "Source1" },
    //         TransformerProvider = new PluginSpec { Type = "Transformer1" },
    //         SinkProvider = new PluginSpec { Type = "Sink1" },
    //         HistoryStoreProvider = new PluginSpec { Type = "Store1" },
    //         DependsOn = []
    //     };

    //     var pipeline2 = new PipelineSpec
    //     {
    //         Name = "Pipeline2",
    //         SourceProvider = new PluginSpec { Type = "Source2" },
    //         TransformerProvider = new PluginSpec { Type = "Transformer2" },
    //         SinkProvider = new PluginSpec { Type = "Sink2" },
    //         HistoryStoreProvider = new PluginSpec { Type = "Store2" },
    //         DependsOn = []
    //     };
    ...
    //     // Act
    //     var layers = PipelineRunGraph. config.BuildLayers();
    ...
    //     var pipeline3 = new PipelineSpec
    //     {
    //         Name = "Pipeline3",
    //         SourceProvider = new PluginSpec { Type = "Source3" },
    //         TransformerProvider = new PluginSpec { Type = "Transformer3" },
    //         SinkProvider = new PluginSpec { Type = "Sink3" },
    //         HistoryStoreProvider = new PluginSpec { Type = "Store3" },
    //         DependsOn = ["Pipeline2"]
    //     };
